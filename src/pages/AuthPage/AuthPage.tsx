...
type UserDelivery =
    ...
    | { type: 'delivery'; city: string; cityRef: string; warehouse: string; warehouseRef: string };
...
export const AuthPage = () => {
    ...
    const [errors, setErrors] = useState({ email: '', password: '', confirmPassword: '', form: '' });
    ...
    const formToggle = isLoginMode ? 'Dont have an account ?' : 'Already have an account?';
    ...
    async function handleSubmit(e: FormEvent<HTMLFormElement>) {
        ...
        if (isLoginMode) {
            ...
            try {
                ...
                const createdUser = await client.post<User>(
                    '/users',
                    newUser
                );
        ...
        <div className="auth-page">
            <div className="auth-page__container">
                ...
                <form onSubmit={handleSubmit} className="auth-form">
                    ...
                    <Button className="button auth-page__button" type="submit" disabled={isLoading}>
                ...
                <div className="auth-page__toggle">
                    <p>
                        ...
                        <Link
                            ...
                            to={`/auth?mode=${formMode}`}>{formToggleLink}</Link>
                    </p>
                </div>
            </div>
        </div>
