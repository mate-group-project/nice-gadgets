  ...
  return (
    <main className="about">
      <div className="about__container">
        <Breadcrumbs crumbs={[{ label: t('about.title') }]} />
        <h1 className="about__page-title">{t('about.title')}</h1>
        <div className="about__content">
          <h2 className="about__heading">{t('about.p1.title')}</h2>
          ...
          <ul className="about__stats">
            <li className="about__stats-item">
              ...
              <p className="about__stats-label">{t('about.years')}</p>
            </li>
            <li className="about__stats-item">
              <p className="about__stats-value">5000+</p>
              <p className="about__stats-label">{t('about.employees')}</p>
            </li>
            <li className="about__stats-item">
              <p className="about__stats-value">540+</p>
              <p className="about__stats-label">{t('about.shops')}</p>
            </li>
            <li className="about__stats-item">
              <p className="about__stats-value">165+</p>
              <p className="about__stats-label">{t('about.cities')}</p>
            </li>
          </ul>
